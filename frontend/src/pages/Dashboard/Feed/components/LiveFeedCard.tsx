    ...
    >
      ...
      <div className="relative flex items-start gap-4">
        ...
        <div className="min-w-0 flex-1">
          ...
          <h3 className="mt-3 line-clamp-2 font-serif text-xl font-black tracking-tight text-white">{event.place}</h3>
      ...
      <div className="relative mt-5 flex flex-wrap items-center gap-2">
        <button onClick={() => onDetails(event)} className="rounded-2xl bg-slate-950 px-4 py-2 text-sm font-bold text-white transition-colors hover:bg-red-700">
          Read the full report
        </button>
        <button className="rounded-2xl border border-cyan-300/20 bg-white/10 p-2 text-cyan-100 transition-colors hover:bg-cyan-400/15" title="Locate on map">
          <LocateFixed className="h-4 w-4" />
        </button>
        <button onClick={share} className="rounded-2xl border border-fuchsia-300/20 bg-white/10 p-2 text-fuchsia-100 transition-colors hover:bg-fuchsia-400/15" title="Copy share link">
          <Share2 className="h-4 w-4" />
        </button>
        <button className="rounded-2xl border border-amber-300/20 bg-white/10 p-2 text-amber-100 transition-colors hover:bg-amber-400/15" title="Save">
