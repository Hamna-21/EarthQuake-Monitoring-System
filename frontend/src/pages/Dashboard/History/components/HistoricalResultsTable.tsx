...
import { formatAlert, formatDepth, formatMagnitude, formatPlace, formatTsunami, formatUtcTime, historicalNote } from '../historyDisplay';
...
function TableTitle() {
  return (
    <div className="bg-gradient-to-r from-cyan-400 via-blue-500 to-violet-500 px-6 py-4">
      ...
      <p title={historicalNote} className="mt-2 max-w-3xl text-xs font-semibold text-white/70">Info: {historicalNote}</p>
    </div>
  );
}
