...
import { MapTileKey, mapTiles } from '@/features/dashboard/map/components/mapStyles';

/** Lets users switch the 2D base tile without changing event coordinates or overlay data. */
