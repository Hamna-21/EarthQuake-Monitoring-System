...
import { Panel } from '@/features/dashboard/components/panelstat';
import MapControlPanelHeader from '@/features/dashboard/map/components/MapControlPanelHeader';
import { MapOverlayControls } from '@/features/dashboard/map/components/MapOverlayControls';
import { MapSearchControl } from '@/features/dashboard/map/components/MapSearchControl';
import MapStyleControl from '@/features/dashboard/map/components/MapStyleControl';
