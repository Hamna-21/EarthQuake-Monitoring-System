...
export default function AnalyticsStatCard({
  ...
  return (
    <AppCard variant="glass" className="group relative overflow-hidden rounded-2xl border border-white/12 bg-white/[0.07] p-3.5 shadow-sm backdrop-blur transition-transform hover:-translate-y-0.5">
