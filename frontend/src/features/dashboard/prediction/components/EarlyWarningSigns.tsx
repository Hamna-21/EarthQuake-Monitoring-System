  ...
  return (
    <section className="relative overflow-hidden rounded-2xl border border-white/15 bg-gradient-to-br from-white/[0.09] via-white/[0.04] to-transparent p-5 shadow-[0_8px_32px_rgba(0,0,0,0.35)] backdrop-blur-2xl">
      ...
      <div className="relative mt-5 grid grid-cols-2 gap-2.5 sm:grid-cols-4">
        {facts.map((f) => (
          <div key={f.label} className={`rounded-xl border border-white/10 bg-gradient-to-br ${f.bg} to-transparent p-3 backdrop-blur-md`}>
      ...
      <div className="relative mt-5 space-y-4">
        {order.map((tier) => {
          ...
          return (
            <div key={tier} className={`rounded-xl border border-white/10 bg-gradient-to-br ${from} ${via} to-transparent p-4 shadow-inner ring-1 ${ring} backdrop-blur-md transition-colors hover:border-white/20`}>
              ...
              <ul className="mt-3 space-y-2 text-sm leading-6 text-slate-200">
                {items.map((s) => (
                  <li key={s.text} className="flex gap-2.5 rounded-lg border border-white/5 bg-white/[0.03] px-2.5 py-2 transition-colors hover:bg-white/[0.06]">
