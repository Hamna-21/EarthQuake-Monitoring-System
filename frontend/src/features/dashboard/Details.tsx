...
export default function DetailsPage({ earthquakes, selectedEvent }: DashboardProps) {
  ...
  return (
    <section className="space-y-6">
     ...
     <CardGrid title="At a Glance" cards={quickStats} columns="lg:grid-cols-4 xl:grid-cols-5" />
<CardGrid title="Full Record" cards={detailCards} columns="lg:grid-cols-4 xl:grid-cols-5" />
