export const ds = {
  ...
  buttonGhost: 'rounded-2xl border border-white/10 bg-white/5 px-4 py-3 text-sm font-black text-white transition hover:border-white/20 hover:bg-white/10',
  input: 'rounded-2xl border border-white/10 bg-white/5 px-3 py-3 text-sm font-semibold text-white outline-none transition placeholder:text-slate-500 focus:border-cyan-400 focus:ring-4 focus:ring-cyan-500/10',
  label: 'text-xs font-black uppercase tracking-[0.18em] text-slate-400',
  title: 'text-4xl font-black tracking-tight text-white md:text-5xl',
  sectionTitle: 'text-2xl font-black tracking-tight text-white',
  caption: 'text-sm font-medium leading-6 text-slate-300',
  badge: 'inline-flex items-center rounded-full border border-white/12 bg-white/10 px-3 py-1 text-xs font-black uppercase tracking-[0.08em] text-cyan-100',
};
